...
import ChildFunctionalComp from './ChildFunctionalComp';
import ChildFunctionalComp_NEW from './ChildFunctionalComp_NEW';
        ...
        return (
            ...
            {console.log("parent render method is running")}
                <MyProvider.Provider value={this.state.contextCounter}>
                    <ChildFunctionalComp propsCounter={this.state.propsCounter}/>
                </MyProvider.Provider>
